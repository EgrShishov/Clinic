using InnoClinic.Contracts.Profiles.Patients.Requests;
using InnoClinic.Contracts.Profiles.Patients.Responses;
using Mapster;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Profiles.Application.Commands.Patients.CreatePatient;
using Profiles.Application.Commands.Patients.DeletePatient;
using Profiles.Application.Commands.Patients.UpdatePatient;
using Profiles.Application.Querires.Patients.SearchPatientByName;
using Profiles.Application.Querires.Patients.ViewAllPatients;
using Profiles.Application.Querires.Patients.ViewById;
